...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__44786__auto__,writer__44787__auto__,opt__44788__auto__){
return cljs.core._write.call(null,writer__44787__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__45862 = o;
(G__45862[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__45864__i < G__45864__a.length) {G__45864__a[G__45864__i] = arguments[G__45864__i + 0]; ++G__45864__i;}
  args = new cljs.core.IndexedSeq(G__45864__a,0);
} 
...
if(cljs.core.truth_((function (){var and__44168__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__44168__auto__){
var and__44168__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__45871 = jsprops;
(G__45871["defaultValue"] = value);

(G__45871["onChange"] = ((function (G__45871,v,value,on_change){
return (function (p1__45868_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__45868_SHARP_);
});})(G__45871,v,value,on_change))
);

(G__45871["ref"] = ((function (G__45871,v,value,on_change){
return (function (p1__45869_SHARP_){
return (this$["cljsInputElement"] = p1__45869_SHARP_);
});})(G__45871,v,value,on_change))
);
...
var vec__45878 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__45878,(0),null);
var id = cljs.core.nth.call(null,vec__45878,(1),null);
var class$ = cljs.core.nth.call(null,vec__45878,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___45883 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___45883 == null)){
} else {
var key_45884 = temp__4661__auto___45883;
(jsprops["key"] = key_45884);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__45886 = (new reagent.impl.template.NativeWrapper());
(G__45886["name"] = c);
...
var len__45255__auto___45892 = arguments.length;
var i__45256__auto___45893 = (0);
while(true){
if((i__45256__auto___45893 < len__45255__auto___45892)){
args__45262__auto__.push((arguments[i__45256__auto___45893]));

var G__45894 = (i__45256__auto___45893 + (1));
i__45256__auto___45893 = G__45894;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45263__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq45890){
var G__45891 = cljs.core.first.call(null,seq45890);
var seq45890__$1 = cljs.core.next.call(null,seq45890);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__45891,seq45890__$1);
});
...
break;
default:
var G__45898 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__45898;
continue;
...
var n__45095__auto___45901 = a.length;
var i_45902 = (0);
while(true){
if((i_45902 < n__45095__auto___45901)){
(a[i_45902] = reagent.impl.template.as_element.call(null,(a[i_45902])));

var G__45903 = (i_45902 + (1));
i_45902 = G__45903;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__45095__auto___45904 = a.length;
var i_45905 = (0);
while(true){
if((i_45905 < n__45095__auto___45904)){
var val_45906 = (a[i_45905]);
if((cljs.core.vector_QMARK_.call(null,val_45906)) && ((reagent.impl.template.key_from_vec.call(null,val_45906) == null))){
(o["no-key"] = true);
} else {
}

(a[i_45905] = reagent.impl.template.as_element.call(null,val_45906));

var G__45907 = (i_45905 + (1));
i_45905 = G__45907;
continue;
} else {
}
...
var ctx = ({});
var vec__45911 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__45911,(0),null);
var derefed = cljs.core.nth.call(null,vec__45911,(1),null);
...
var G__45915 = (cljs.core.count.call(null,argv) - first_child);
switch (G__45915) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__45915){
...
//# sourceMappingURL=template.js.map?rel=1482058324052