...
var o__55295__auto__ = (function (){var temp__4657__auto__ = goog.object.get(window,"cljs");
if(cljs.core.truth_(temp__4657__auto__)){
var o__55307__auto__ = temp__4657__auto__;
return goog.object.get(o__55307__auto__,"core");
} else {
return null;
}
})();
return goog.object.get(o__55295__auto__,"js_reserved_QMARK_").call(o__55295__auto__,x);
});
devtools.munging.get_fn_source_safely = (function devtools$munging$get_fn_source_safely(f){
try{var o__55295__auto__ = f;
return goog.object.get(o__55295__auto__,"toString").call(o__55295__auto__);
}catch (e57570){var _ = e57570;
return "";
}});
...
try{var o__55295__auto___57573 = t;
goog.object.get(o__55295__auto___57573,"cljs$lang$ctorPrWriter").call(o__55295__auto___57573,t,writer);
}catch (e57572){var __57574 = e57572;
}
...
var char_code = (function (){var o__55295__auto__ = (new String(char$));
return goog.object.get(o__55295__auto__,"charCodeAt").call(o__55295__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__55295__auto__ = String;
return goog.object.get(o__55295__auto__,"fromCharCode").call(o__55295__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__57576 = num_code;
switch (G__57576) {
case (1):
return (185);
...
var o__55295__auto__ = String;
return goog.object.get(o__55295__auto__,"fromCharCode").call(o__55295__auto__,superscript_code);
});
/**
...
}catch (e57582){var e__55320__auto__ = e57582;
return false;
}})())){
...
var vec__57583 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__57583,(0),null);
...
var or__44180__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
var temp__4657__auto____$1 = goog.object.get(o__55308__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__55307__auto__ = temp__4657__auto____$1;
return goog.object.get(o__55307__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__45255__auto___57592 = arguments.length;
var i__45256__auto___57593 = (0);
while(true){
if((i__45256__auto___57593 < len__45255__auto___57592)){
args__45262__auto__.push((arguments[i__45256__auto___57593]));

var G__57594 = (i__45256__auto___57593 + (1));
i__45256__auto___57593 = G__57594;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45263__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__57588){
var vec__57589 = p__57588;
var ns_detector = cljs.core.nth.call(null,vec__57589,(0),null);
var effective_detector = (function (){var or__44180__auto__ = ns_detector;
if(cljs.core.truth_(or__44180__auto__)){
return or__44180__auto__;
} else {
...
var G__57595 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__57596 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__57595;
remaining_tokens = G__57596;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq57586){
var G__57587 = cljs.core.first.call(null,seq57586);
var seq57586__$1 = cljs.core.next.call(null,seq57586);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__57587,seq57586__$1);
});
...
break;
default:
var o__55295__auto__ = window;
return goog.object.get(o__55295__auto__,"parseInt").call(o__55295__auto__,arity,(10));
...
var vec__57604 = cljs.core.split_with.call(null,(function (p1__57600_SHARP_){
return cljs.core.not_EQ_.call(null,p1__57600_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__57604,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__57604,(1),null);
...
var vec__57610 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__57610,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__57610,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__57613 = cljs.core.rest.call(null,remaining_tokens);
var G__57614 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__57613;
name_tokens = G__57614;
continue;
} else {
...
var args57615 = [];
var len__45255__auto___57627 = arguments.length;
var i__45256__auto___57628 = (0);
while(true){
if((i__45256__auto___57628 < len__45255__auto___57627)){
args57615.push((arguments[i__45256__auto___57628]));

var G__57629 = (i__45256__auto___57628 + (1));
i__45256__auto___57628 = G__57629;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args57615.length)].join('')));
...
var vec__57618 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__57618,(0),null);
var arity = cljs.core.nth.call(null,vec__57618,(1),null);
var vec__57621 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__57621,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__57621,(1),null);
var vec__57624 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__57624,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__57624,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__57624,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__57624,(3),null);
...
var args57631 = [];
var len__45255__auto___57637 = arguments.length;
var i__45256__auto___57638 = (0);
while(true){
if((i__45256__auto___57638 < len__45255__auto___57637)){
args57631.push((arguments[i__45256__auto___57638]));

var G__57639 = (i__45256__auto___57638 + (1));
i__45256__auto___57638 = G__57639;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args57631.length)].join('')));
...
var vec__57634 = result;
var munged_ns = cljs.core.nth.call(null,vec__57634,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__57634,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__57634,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__57634,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__57634,(4),null);
var arity = cljs.core.nth.call(null,vec__57634,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__57647 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__57647,(0),null);
var args = cljs.core.nth.call(null,vec__57647,(1),null);
var vec__57650 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__57650,(0),null);
var name = cljs.core.nth.call(null,vec__57650,(1),null);
...
var G__57653 = (arity + (1));
var G__57654 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__57655){
var vec__57659 = p__57655;
var arity = cljs.core.nth.call(null,vec__57659,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__57659,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__44180__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__44180__auto__)){
return or__44180__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__57662_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__57663_SHARP_);
...
var args__45262__auto__ = [];
var len__45255__auto___57670 = arguments.length;
var i__45256__auto___57671 = (0);
while(true){
if((i__45256__auto___57671 < len__45255__auto___57670)){
args__45262__auto__.push((arguments[i__45256__auto___57671]));

var G__57672 = (i__45256__auto___57671 + (1));
i__45256__auto___57671 = G__57672;
continue;
} else {
}
break;
...
var argseq__45263__auto__ = ((((1) < args__45262__auto__.length))?(new cljs.core.IndexedSeq(args__45262__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__45263__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__57666){
var vec__57667 = p__57666;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__57667,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq57664){
var G__57665 = cljs.core.first.call(null,seq57664);
var seq57664__$1 = cljs.core.next.call(null,seq57664);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__57665,seq57664__$1);
});
...
var G__57674 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__57674) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__44180__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__44180__auto__)){
return or__44180__auto__;
} else {
...
return [cljs.core.str((cljs.core.truth_((function (){var and__44168__auto__ = include_ns_QMARK_;
...
return [cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str(protocol_name)].join(''):null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str((cljs.core.truth_((function (){var or__44180__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__44180__auto__)){
return or__44180__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__57681__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__57681__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__57681__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__57681__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__57682 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__57682,(0),null);
var fn_name = cljs.core.nth.call(null,vec__57682,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__57682,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__57682,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__57682,(4),null);
var arity = cljs.core.nth.call(null,vec__57682,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__44168__auto__ = protocol_ns;
if(cljs.core.truth_(and__44168__auto__)){
return cljs.core.not.call(null,(function (){var and__44168__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str((function (){var or__44180__auto__ = protocol_part;
if(cljs.core.truth_(or__44180__auto__)){
return or__44180__auto__;
} else {
return fn_part;
...
var o__55295__auto__ = f;
return goog.object.get(o__55295__auto__,"getBasis").call(o__55295__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__44168__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__44168__auto__)){
...
}catch (e57687){var e__55320__auto__ = e57687;
...
var G__57688 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__57689 = cljs.core.rest.call(null,path);
obj = G__57688;
path = G__57689;
continue;
} else {
...
var partition_bits = (function (){var or__44180__auto__ = goog.object.get(obj,partition_key);
if(cljs.core.truth_(or__44180__auto__)){
return or__44180__auto__;
} else {
return (0);
...
return (function (accum,p__57694){
var vec__57695 = p__57694;
var bit = cljs.core.nth.call(null,vec__57695,(0),null);
var protocol = cljs.core.nth.call(null,vec__57695,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__57698){
var vec__57702 = p__57698;
var ns = cljs.core.nth.call(null,vec__57702,(0),null);
var name = cljs.core.nth.call(null,vec__57702,(1),null);
var selector = cljs.core.nth.call(null,vec__57702,(2),null);
...
return (function (p__57710){
var vec__57711 = p__57710;
var munged_name = cljs.core.nth.call(null,vec__57711,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__57711,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__57711,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__57705_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__57705_SHARP_));
});})(name,sorted_matches,vec__57711,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1482058335387