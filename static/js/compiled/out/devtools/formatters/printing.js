...
var len__45255__auto___57749 = arguments.length;
var i__45256__auto___57750 = (0);
while(true){
if((i__45256__auto___57750 < len__45255__auto___57749)){
args__45262__auto__.push((arguments[i__45256__auto___57750]));

var G__57751 = (i__45256__auto___57750 + (1));
i__45256__auto___57750 = G__57751;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__45263__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq57746){
var G__57747 = cljs.core.first.call(null,seq57746);
var seq57746__$1 = cljs.core.next.call(null,seq57746);
var G__57748 = cljs.core.first.call(null,seq57746__$1);
var seq57746__$2 = cljs.core.next.call(null,seq57746__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__57747,G__57748,seq57746__$2);
});
...
if(cljs.core.truth_((function (){var or__44180__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__44786__auto__,writer__44787__auto__,opt__44788__auto__){
return cljs.core._write.call(null,writer__44787__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__44168__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__44168__auto__){
var or__44180__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__44180__auto__)){
return or__44180__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__57752_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__57752_SHARP_));
})))){
...
var map__57761 = opts;
var map__57761__$1 = ((((!((map__57761 == null)))?((((map__57761.cljs$lang$protocol_mask$partition0$ & (64))) || (map__57761.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__57761):map__57761);
var markup_db = cljs.core.get.call(null,map__57761__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__44180__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e57765){var e__55320__auto__ = e57765;
return false;
}})();
if(cljs.core.truth_(or__44180__auto__)){
return or__44180__auto__;
...
}catch (e57767){var e__55320__auto__ = e57767;
return false;
}}
})())){
...
var _STAR_current_state_STAR_57772 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__57773 = opts;
var map__57773__$1 = ((((!((map__57773 == null)))?((((map__57773.cljs$lang$protocol_mask$partition0$ & (64))) || (map__57773.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__57773):map__57773);
var markup_db = cljs.core.get.call(null,map__57773__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_57772;
}});
...
;
var temp__4655__auto___57778 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___57778)){
var managed_print_level_57779 = temp__4655__auto___57778;
var _STAR_print_level_STAR_57777_57780 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_57779;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_57777_57780,managed_print_level_57779,temp__4655__auto___57778,writer,opts,job_fn){
return (function (p1__57775_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__57775_SHARP_,null);
});})(_STAR_print_level_STAR_57777_57780,managed_print_level_57779,temp__4655__auto___57778,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_57777_57780;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1482058335564