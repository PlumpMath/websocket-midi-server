...
var len__26126__auto___29638 = arguments.length;
var i__26127__auto___29639 = (0);
while(true){
if((i__26127__auto___29639 < len__26126__auto___29638)){
args__26133__auto__.push((arguments[i__26127__auto___29639]));

var G__29640 = (i__26127__auto___29639 + (1));
i__26127__auto___29639 = G__29640;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26134__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29635){
var G__29636 = cljs.core.first.call(null,seq29635);
var seq29635__$1 = cljs.core.next.call(null,seq29635);
var G__29637 = cljs.core.first.call(null,seq29635__$1);
var seq29635__$2 = cljs.core.next.call(null,seq29635__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__29636,G__29637,seq29635__$2);
});
...
if(cljs.core.truth_((function (){var or__25051__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__25657__auto__,writer__25658__auto__,opt__25659__auto__){
return cljs.core._write.call(null,writer__25658__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__25039__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__25039__auto__){
var or__25051__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__25051__auto__)){
return or__25051__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29641_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__29641_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__29650__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__25051__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e29654){var e__27119__auto__ = e29654;
return false;
}})();
if(cljs.core.truth_(or__25051__auto__)){
return or__25051__auto__;
...
}catch (e29656){var e__27119__auto__ = e29656;
return false;
}}
})())){
...
var _STAR_current_state_STAR_29661 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__29662 = opts;
var map__29662__$1 = ((((!((map__29662 == null)))?((((map__29662.cljs$lang$protocol_mask$partition0$ & (64))) || (map__29662.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__29662):map__29662);
var markup_db = cljs.core.get.call(null,map__29662__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_29661;
}});
...
;
var temp__4655__auto___29667 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___29667)){
var managed_print_level_29668 = temp__4655__auto___29667;
var _STAR_print_level_STAR_29666_29669 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_29668;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_29666_29669,managed_print_level_29668,temp__4655__auto___29667,writer,opts,job_fn){
return (function (p1__29664_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__29664_SHARP_,null);
});})(_STAR_print_level_STAR_29666_29669,managed_print_level_29668,temp__4655__auto___29667,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_29666_29669;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1485162149005