...
var and__25039__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__25039__auto__){
var or__25051__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e30079){var e__27119__auto__ = e30079;
return false;
...
}catch (e30081){var e__27119__auto__ = e30081;
return false;
...
}catch (e30087){var e__27119__auto__ = e30087;
return false;
...
}catch (e30089){var e__27119__auto__ = e30089;
return false;
...
}catch (e30095){var e__27119__auto__ = e30095;
return false;
}})())){
...
}catch (e30097){var e__27119__auto__ = e30097;
return false;
}})())){
...
var _STAR_current_state_STAR_30100 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__25051__auto__ = config;
if(cljs.core.truth_(or__25051__auto__)){
return or__25051__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_30100;
}});
});
...
while (G__30104__i < G__30104__a.length) {G__30104__a[G__30104__i] = arguments[G__30104__i + 0]; ++G__30104__i;}
  args = new cljs.core.IndexedSeq(G__30104__a,0);
} 
...
var pre_handler = (function (){var or__25051__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__25051__auto__)){
return or__25051__auto__;
} else {
...
var post_handler = (function (){var or__25051__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__25051__auto__)){
return or__25051__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1485216609204