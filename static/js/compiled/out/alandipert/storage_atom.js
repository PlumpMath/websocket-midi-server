...
var x__44848__auto__ = (((this$ == null))?null:this$);
var m__44849__auto__ = (alandipert.storage_atom._get[goog.typeOf(x__44848__auto__)]);
if(!((m__44849__auto__ == null))){
return m__44849__auto__.call(null,this$,not_found);
} else {
var m__44849__auto____$1 = (alandipert.storage_atom._get["_"]);
if(!((m__44849__auto____$1 == null))){
return m__44849__auto____$1.call(null,this$,not_found);
} else {
...
var x__44848__auto__ = (((this$ == null))?null:this$);
var m__44849__auto__ = (alandipert.storage_atom._commit_BANG_[goog.typeOf(x__44848__auto__)]);
if(!((m__44849__auto__ == null))){
return m__44849__auto__.call(null,this$,value);
} else {
var m__44849__auto____$1 = (alandipert.storage_atom._commit_BANG_["_"]);
if(!((m__44849__auto____$1 == null))){
return m__44849__auto____$1.call(null,this$,value);
} else {
...
alandipert.storage_atom.StorageBackend.cljs$lang$ctorPrWriter = (function (this__44791__auto__,writer__44792__auto__,opt__44793__auto__){
return cljs.core._write.call(null,writer__44792__auto__,"alandipert.storage-atom/StorageBackend");
});
...
var G__54318 = atom;
cljs.core.add_watch.call(null,G__54318,new cljs.core.Keyword("alandipert.storage-atom","storage-watch","alandipert.storage-atom/storage-watch",1159565749),((function (G__54318,existing,debounce){
return (function (p1__54315_SHARP_,p2__54316_SHARP_,p3__54313_SHARP_,p4__54314_SHARP_){
if(cljs.core.truth_((function (){var and__44173__auto__ = alandipert.storage_atom._STAR_watch_active_STAR_;
if(cljs.core.truth_(and__44173__auto__)){
return cljs.core.not_EQ_.call(null,p3__54313_SHARP_,p4__54314_SHARP_);
} else {
return and__44173__auto__;
}
})())){
return debounce.call(null,((function (G__54318,existing,debounce){
return (function (){
return alandipert.storage_atom._commit_BANG_.call(null,backend,p4__54314_SHARP_);
});})(G__54318,existing,debounce))
,(function (){var or__44185__auto__ = alandipert.storage_atom._STAR_storage_delay_STAR_;
...
var _STAR_watch_active_STAR_54322 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;

try{return cljs.core.reset_BANG_.call(null,atom,default$);
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_54322;
}} else {
...
var _STAR_watch_active_STAR_54324 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;
...
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_54324;
}} else {
return null;
}
} else {
...
return alandipert.storage_atom.maybe_update_backend.call(null,atom,storage,k,default$,p1__54325_SHARP_);
});})(default$))
);
});
/**
...
//# sourceMappingURL=storage_atom.js.map?rel=1484992966016