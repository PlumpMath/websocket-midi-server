...
var m__25715__auto__ = (alandipert.storage_atom._get[goog.typeOf(x__25714__auto__)]);
if(!((m__25715__auto__ == null))){
return m__25715__auto__.call(null,this$,not_found);
} else {
var m__25715__auto____$1 = (alandipert.storage_atom._get["_"]);
if(!((m__25715__auto____$1 == null))){
return m__25715__auto____$1.call(null,this$,not_found);
} else {
...
var x__25714__auto__ = (((this$ == null))?null:this$);
var m__25715__auto__ = (alandipert.storage_atom._commit_BANG_[goog.typeOf(x__25714__auto__)]);
if(!((m__25715__auto__ == null))){
return m__25715__auto__.call(null,this$,value);
} else {
var m__25715__auto____$1 = (alandipert.storage_atom._commit_BANG_["_"]);
if(!((m__25715__auto____$1 == null))){
return m__25715__auto____$1.call(null,this$,value);
} else {
...
alandipert.storage_atom.StorageBackend.cljs$lang$ctorPrWriter = (function (this__25657__auto__,writer__25658__auto__,opt__25659__auto__){
return cljs.core._write.call(null,writer__25658__auto__,"alandipert.storage-atom/StorageBackend");
});
...
var G__27032 = atom;
cljs.core.add_watch.call(null,G__27032,new cljs.core.Keyword("alandipert.storage-atom","storage-watch","alandipert.storage-atom/storage-watch",1159565749),((function (G__27032,existing,debounce){
return (function (p1__27029_SHARP_,p2__27030_SHARP_,p3__27027_SHARP_,p4__27028_SHARP_){
if(cljs.core.truth_((function (){var and__25039__auto__ = alandipert.storage_atom._STAR_watch_active_STAR_;
if(cljs.core.truth_(and__25039__auto__)){
return cljs.core.not_EQ_.call(null,p3__27027_SHARP_,p4__27028_SHARP_);
} else {
return and__25039__auto__;
}
})())){
return debounce.call(null,((function (G__27032,existing,debounce){
return (function (){
return alandipert.storage_atom._commit_BANG_.call(null,backend,p4__27028_SHARP_);
});})(G__27032,existing,debounce))
,(function (){var or__25051__auto__ = alandipert.storage_atom._STAR_storage_delay_STAR_;
...
var _STAR_watch_active_STAR_27036 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;

try{return cljs.core.reset_BANG_.call(null,atom,default$);
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_27036;
}} else {
...
var _STAR_watch_active_STAR_27038 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;
...
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_27038;
}} else {
return null;
}
} else {
...
return alandipert.storage_atom.maybe_update_backend.call(null,atom,storage,k,default$,p1__27039_SHARP_);
});})(default$))
);
});
/**
...
//# sourceMappingURL=storage_atom.js.map?rel=1485036130753